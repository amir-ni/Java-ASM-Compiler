...
public class nor extends  Instruction { // nor $rd, $rs, $rt
    private static int OPCODE = 0;
    private static int FUNCT = 39;

    public nor(Assembler assembler,String instruction,String instructionPart2 , int startClock , long address) throws UnformattedInstructionException, IllegalRegisterNumberException {
