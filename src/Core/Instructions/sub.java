...
public class sub extends Instruction { // sub $rd, $rs, $rt
    private static int OPCODE = 0;
    private static int FUNCT = 34;

    public sub(Assembler assembler,String instruction, String instructionPart2, int startClock, long address) throws UnformattedInstructionException, IllegalRegisterNumberException {
