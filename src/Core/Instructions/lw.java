...
public class lw extends Instruction { // lw $rt, offset($rs)
    private static int OPCODE = 35;

    public lw(Assembler assembler,String instruction, String instructionPart2, int startClock, long address) throws UnformattedInstructionException, IllegalRegisterNumberException {
    ...
    public void run() {
        ...
        int loadedValue = getAssembler().loadMemory(address);
        registers[getRt_register()] = loadedValue;
    }
