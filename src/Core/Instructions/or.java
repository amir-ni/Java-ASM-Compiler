...
public class or extends Instruction { // or $rd, $rs, $rt
    private static int OPCODE = 0;
    private static int FUNCT = 37;

    public or(Assembler assembler, String instruction, String instructionPart2, int startClock, long address) throws UnformattedInstructionException, IllegalRegisterNumberException {
