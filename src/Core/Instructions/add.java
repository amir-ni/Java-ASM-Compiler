...
public class add extends Instruction { // add $rd, $rs, $rt
    private static int OPCODE = 0;
    private static int FUNCT = 32;


    public add(Assembler assembler,String instruction, String instructionPart2, int startClock, long address) throws UnformattedInstructionException, IllegalRegisterNumberException {
